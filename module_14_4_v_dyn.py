"""
В этом коде по сравнению с первой версией выдача доступных для покупки продуктов связана с данными из базы.
 Для этого изменена клавиатура kb_products (строка 29):
 Вместо заранее заданных "Product1, Product2, ..." в клавиатуре использованы реальные названия продуктов из базы данных.
"""
